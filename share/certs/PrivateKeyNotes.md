...
unlocked to sign the Socialcoin-Qt.app bundle.
...
allowing somebody to distribute a Socialcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the socialcoin-qt.exe file inside the installer had not been tampered with.
